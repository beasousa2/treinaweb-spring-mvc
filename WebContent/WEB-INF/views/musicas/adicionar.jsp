			...
			<div class="row">
  			...
  			<div class="row">
				<div class="form-group col-md-6 col-xs-12">
    				...
    				<f:input path="creationDate" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"/>
  			...
  			<div class="row">
	  			<div class="form-group col-md-6 col-xs-12">
    				...
    				<f:select path="album.id" class="form-control" id="exampleInputPassword1">
