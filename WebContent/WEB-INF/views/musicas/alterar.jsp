...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="f" %>    
	...
	<j:url var="actionChange" value="/musicas/alterarMusica" ></j:url>
	
	<div>
		<h3 class="text-center h3 text-primary">Alterar a Música ${musicas.musicName} </h3>
	
		<f:form action="${actionChange}" method="POST">
			<div class="row">
