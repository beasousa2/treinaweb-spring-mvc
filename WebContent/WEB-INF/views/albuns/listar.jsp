<%@ taglib prefix="j" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div class="row" >
		...
		<div class="col-md-6" >
			<a class="btn btn-primary btn-md" href="/TreinawebSpringMVC/albuns/adicionar">
				<span>Adicionar</span>
  				...
  				<j:if test="${!empty albuns }">
  					<j:forEach items="${albuns}" var="al">
  						<tr>
      						...
      						<td> 
      							<a class="btn btn-success btn-sm" href="/TreinawebSpringMVC/albuns/alterar/${al.id}" role="button">
      						...
      						<td> 
      							<a class="btn btn-danger btn-sm" href="/TreinawebSpringMVC/albuns/excluir/${al.id}" role="button">
